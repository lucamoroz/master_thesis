...
\begin{document}
	...
	\begin{figure}\centering
		\subfloat[CV]{\includegraphics[width = 3in]{img/stable_workload_threshold_cv.png}}
		\hfill 
		\subfloat[MinMax]{\includegraphics[width = 3in]{img/stable_workload_threshold_minmax.png}} 
		\hfill
		\subfloat[Normal]{\includegraphics[width = 3in]{img/stable_workload_threshold_normal.png}} 
	...
	\begin{figure}\centering
		...
		\subfloat[Real requests]{\includegraphics[width = 2in]{img/ts/bank.png}} 
	...
	\begin{figure}\centering
		...
		\subfloat[Real requests]{\includegraphics[width = 2.5in]{img/results_clustering_kmeans_bank.png}} 
	...
	\begin{figure}\centering
		...
		\subfloat[Real requests]{\includegraphics[width = 2.5in]{img/results_clustering_meanshift_bank.png}} 
	...
	\begin{figure}\centering
		...
		\subfloat[Failures]{\includegraphics[width = 5.5in]{img/results/mongo_allianz_10ms_kmeans_fail.png}}
